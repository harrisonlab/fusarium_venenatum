...
This document details the commands used for gene prediction and annotation of the reference genome of fusarium venenatum

```
The assembly pipeline SMARTdenovo + medaka generated the best assembly. See 01.MinION_Assembly.md
```
...
OutDir=alignment/star/F.venenatum/WT_minion/medaka_assembly_star/concatenated_vAG
mkdir -p $OutDir
samtools merge -f $OutDir/concatenated.bam $BamFiles
```
